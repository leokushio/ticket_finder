class XTexts {
  ...
  static const String gridView3 = 'Выходные';
  static const String gridView4 = 'Горячие \n билеты';

  static List<String> gridStrings = [gridView1, gridView2, gridView3, gridView4];

  // recomended cities
  static const String istanbul = 'Стамбул';
